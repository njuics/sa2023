import{h as _,j as d,k as p,al as h,c as m,am as u,m as n,an as t,ao as s,A as o,F as f,ap as g,aq as v,ar as x,s as r,as as y,at as b,q as N,au as k,av as w,_ as P}from"./nav-e18855be.js";import{N as S}from"./NoteDisplay-959abde5.js";import{u as V}from"./index-8a73d571.js";const j={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},H={class:"opacity-50"},q=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},A=_({__name:"PresenterPrint",setup(F){d(p),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
